...
3.G.Visu pirma yra tikrinama u sinchronizavima užtikrina Lock ir Monitor.Enter.
...
Kai gija Ivykdo užduoti(patikrina ar du failai yra dublikatais) ji bando gauti nauja užduoti(tam kad kiekviena gija gautu savo užduoti ir nekilnojama Queue ir Monitor.Enter);
...
2.Jai char sutapo tada nuskaitoma is failu po eilute ir jos yra tikrinamos. Nuskaitome eilute nes tikrini eilute su eilute užima mažiau laiko nei tikrinti viska char by char.Už tai reiks moketi tuo kad eilute užima daugiau vietos atmintyje.
3.Kai gija randa nesutapima toliau ne tikrina ir gauna nauja uzduoti.(Taigi failai nuskaitomi iki galo tik dada jai jie yra dublikatais).
